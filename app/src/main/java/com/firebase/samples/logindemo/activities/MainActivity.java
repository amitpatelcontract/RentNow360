...
// * general methods).
// * <p/>
// * Facebook provides its own API via the {@link LoginButton}.
// * Google provides its own API via the {@link GoogleApiClient}.
...
//
//    String id = null, displayName = null, email = null, profileImageURL = null, accessToken = null, gender = null, last_name = null, first_name = null, age_range = null, locale = null, timezone=null;
//
//    /* *************************************
//     *              PASSWORD               *
//     ***************************************/
...
//        mFirebaseRef = new Firebase(FirebaseUrls.FIREBASE_URL);
//
...
//        super.onResume();
//        if (HelpUtils.getuserDataFromSharedPreferance(MainActivity.this)!=null)
...
//                // cachedUserProfile
//
//                LinkedHashMap cachedUserProfile = (LinkedHashMap) authData.getProviderData().get("cachedUserProfile");
//
...
//                HelpUtils.saveUserDataInSharedPreferance(new User(id, accessToken, displayName, profileImageURL, email, LocationUtils.getLocationManager(MainActivity.this).loc, cachedUserProfile), MainActivity.this);
//
//                    UserManagement.setUpUser(MainActivity.this);
//
//                    HelpUtils.OpenListOfProducts(MainActivity.this);
//
...
//                mGoogleConnectionResult.startResolutionForResult(MainActivity.this, RC_GOOGLE_LOGIN);
